...
export const projects = [
  {
    ...
    description:
      "Fullstack приложение для вызова такси с интерактивным UI и выбором маршрута.",
    stack: "React, Firebase, PHP, SCSS",
  },
  {
    title: "Meal Planner",
    category: "React",
    ...
    description:
      "Приложение для планирования питания с калориями, фильтрами и рецептами.",
  ...
  },
  {
    ...
    description:
      "Минималистичный видеоплеер с управлением YouTube плейлистами и визуализацией.",
    stack: "React, Zustand, YouTube API",
  },
  {
    title: "React Resume",
    category: "PHP",
    ...
    stack: "React, PHP, CSS, Framer Motion",
  },
];
